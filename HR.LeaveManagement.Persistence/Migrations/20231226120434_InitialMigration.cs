    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "LeaveTypes",
                columns: new[] { "Id", "DataCreated", "DataModified", "DefaultDays", "Name" },
                values: new object[] { 1, new DateTime(2023, 12, 26, 15, 4, 34, 385,
                DateTimeKind.Local).AddTicks(98), new DateTime(2023, 12, 26, 15, 4, 34, 385,
                DateTimeKind.Local).AddTicks(111), 10, "Vacation" });
